...
def Create_Window_Export_As_File(W_Calc_Frecuences_Table , Results_From_Single_Column , Results_From_Multiple_Column , Type_Of_Variable_For_Single_Column , Type_Of_Variable_For_Multiple_Column):
    ...
    W_Export_As_File.geometry("700x500")
    ...
    Btn_Export_In_Excel = Button(W_Export_As_File , text="Exportar como Excel" , font=("Times New Roman" , 13) , command= lambda: Create_Window_Export_Excel(W_Export_As_File , Results_From_Single_Column , Results_From_Multiple_Column , Type_Of_Variable_For_Single_Column , Type_Of_Variable_For_Multiple_Column))
    Btn_Export_In_Excel.place(x=100 , y=170 , width=500)

    Btn_Export_In_PDF = Button(W_Export_As_File , text="Exportar como PDF" , font=("Times New Roman" , 13) , command= lambda: Create_Window_Export_PDF(W_Export_As_File , Results_From_Single_Column , Results_From_Multiple_Column))
